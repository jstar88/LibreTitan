...
class ShowFleetShortcuts
{
	...
	public function __construct($CurrentUser)
	{
		...
		if(!empty($_GET['mode']))
		{
			...
			{
				$this->addFleetShortcuts((strip_tags($_POST["name"])),intval($_POST["galaxy"]),intval($_POST["system"]),intval($_POST["planet"]),intval($_POST["moon"]));
			}
			elseif($mode=="edit" && isset($_GET['a']) && !empty($_POST['galaxy'])&&!empty($_POST['system'])&&!empty($_POST['planet']) )
			{
				$this->saveFleetShortcuts(intval($_GET['a']),(strip_tags($_POST["name"])),intval($_POST["galaxy"]),intval($_POST["system"]),intval($_POST["planet"]),intval($_POST["moon"]));
			}
