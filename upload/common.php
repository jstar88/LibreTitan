...
Autoloader::setClassPaths(array('includes/'));
Autoloader::init();
//---------------------------
...
Xtreme::setCachesDirectory(CACHE_DIR);
Xtreme::setTemplatesDirectory(TEMPLATE_DIR);
Xtreme::setLanguagesDirectory(LANGUAGE_DIR);
Xtreme::setScriptsDirectory(SCRIPT_DIR);
Xtreme::switchCountry(DEFAULT_LANG);
Xtreme::useCompileCompression(false);
Xtreme::assignLangFile('INGAME');
Xtreme::assignLangFile('SERVER');
//---------------------------
