...
if(!defined('INSIDE')){ die(header("location:../../"));}
	...
	function InsertJavaScriptChronoAppletJstar ($Type, $Ref, $Value, $Init)
	{
		...
		if ($Init == true)
		{
			...
			$JavaString .= "	}\n";
      $JavaString .= "	if (h". $Type . $Ref ." > 23) {\n";
			$JavaString .= "		d". $Type . $Ref ." = Math.floor(h". $Type . $Ref ." / 24);\n";
			$JavaString .= "		h". $Type . $Ref ." = h". $Type . $Ref ." - d". $Type . $Ref ." * 24;\n";
			$JavaString .= "	}\n";
			...
			$JavaString .= "	}\n";
			$JavaString .= "if(d". $Type . $Ref .">0){\n";
			$JavaString .= "	bxx". $Type . $Ref .".innerHTML = d". $Type . $Ref ." + \"g  \" + h". $Type . $Ref ." + \"h \" + m". $Type . $Ref ." + \"m \" + ss". $Type . $Ref ." + \"s\";\n";
			$JavaString .= "}\n";
			$JavaString .= "else if(h". $Type . $Ref .">0) {\n";
			$JavaString .= "	bxx". $Type . $Ref .".innerHTML = h". $Type . $Ref ." + \"h \" + m". $Type . $Ref ." + \"m \" + ss". $Type . $Ref ."+ \"s\";\n";
			$JavaString .= "}\n";
			$JavaString .= "else if (m". $Type . $Ref .">0) {\n";
			$JavaString .= "	bxx". $Type . $Ref .".innerHTML = m". $Type . $Ref ." + \"m \" + ss". $Type . $Ref ."+ \"s\";\n";
			$JavaString .= "}\n";
			$JavaString .= "else {\n";
			$JavaString .= "	bxx". $Type . $Ref .".innerHTML = ss". $Type . $Ref ."+ \"s\";\n";
			$JavaString .= "}\n";
      $JavaString .= "}\n";
