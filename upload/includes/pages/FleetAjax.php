...
/*echo $_POST['mission']."mission";
echo $_POST['universe']."universe";
echo $_POST['galaxy']."galaxy";
echo $_POST['system']."system";
echo $_POST['mission']."mission";
echo $_POST['ship209']."riciclatrici";
*/
...
//start mod
$QrySelectEnemy .= "`universe` = '".intval( $_POST['universe']) ."' AND ";
//end mod
