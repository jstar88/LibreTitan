...
rename_function('strlen', 'strlen_stub');
override_function('strlen', '$string', 'return override_strlen($string);');
function override_strlen($string){
        return strlen_stub(utf8_decode(utf8_bad_clean($string))); 
}

rename_function('substr', 'substr_stub');
override_function('substr', '$str, $offset, $length', 'return override_substr($str, $offset, $length);');
function override_substr($str, $offset, $length = false)
{
...
rename_function('strpos', 'strpos_stub');
override_function('strpos', '$str, $needle, $offset', 'return override_strpos($str, $needle, $offset);');
function override_strpos($str, $needle, $offset = false)
{
	if ($offset === false)
	{
	...
	if (($pos = override_strpos($str, $needle)) !== false)
		return $pos + $offset;

	return false;
}  

rename_function('strrpos', 'strrpos_stub');
override_function('strrpos', '$str, $needle, $offset', 'return override_strrpos($str, $needle, $offset);');
function override_strrpos($str, $needle, $offset = false)
{
	if ($offset === false)
	{
	...
	if (($pos = strrpos($str, $needle)) !== false)
		return $pos + $offset;

	return false;
}

rename_function('strtolower', 'strtolower_stub');
override_function('strtolower', '$string', 'return override_strtolower($string);');
function override_strtolower($string)
{
...
rename_function('strtoupper', 'strtoupper_stub');
override_function('strtoupper', '$string', 'return override_strtoupper($string);');
function override_strtoupper($string)
{
...
rename_function('substr_replace', 'substr_replace_stub');
override_function('substr_replace', '$str, $repl, $start, $length', 'return override_substr_replace($str, $repl, $start, $length);');
function override_substr_replace($str, $repl, $start, $length = null)
{
...
rename_function('ucwords', 'ucwords_stub');
override_function('ucwords', '$str', 'return override_ucwords($str);');
function override_ucwords($str)
{
...
function _utf8_ucwords_callback($matches)
{
	...
	$ucword = substr_replace(ltrim($matches[0]), $ucfirst, 0, 1);
