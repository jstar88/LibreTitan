...
$QryTableFleets     .= "`fleet_start_id` int(11) NOT NULL default '0', ";
...
$QryTableFleets     .= "`fleet_start_name` int(11) NOT NULL default '0', ";
$QryTableFleets     .= "`fleet_end_time` int(11) NOT NULL default '0', ";
$QryTableFleets     .= "`fleet_end_stay` int(11) NOT NULL default '0', ";
$QryTableFleets     .= "`fleet_end_id` int(11) NOT NULL default '0', ";
...
$QryTableFleets     .= "`fleet_end_name` int(11) NOT NULL default '0', ";
...
$QryTablePlanets    .= "`destruyed_moon` int(11) NOT NULL default '0', ";
$QryTablePlanets    .= "`destruyed_planet` int(11) NOT NULL default '0', ";
