...
switch($_POST[search])
{
	...
	elseif ($_POST['key_order'] == 'id_owner')
		$c	=	'checked = "checked"';
  elseif ($_POST['key_order'] == 'universe')
		$k	=	'checked = "checked"';
	...
	$parse['orderby']	=
				...
				<tr>
					...
					<th width="20%"><input type="radio" name="key_order" value="universe" '.$k.'></th>
	...
	else
	{
		while ($planet	=	mysql_fetch_array($search))
		{
			...
			<td class=\"c\">".$lang['se_universe']."</th><td class=\"c\">".$lang['se_galaxy']."</th><td class=\"c\">".$lang['se_system']."</th><td class=\"c\">".$lang['se_planet']."</th>
	...
	else
	{
		while ($moon	=	mysql_fetch_array($search))
		{
			...
			"<table width=\"65%\">
			<tr><td class=\"c\">".$lang['se_id']."</th><td class=\"c\">".$lang['se_name']."</th><td class=\"c\">".$lang['se_id_owner']."</th>
			<td class=\"c\">".$lang['se_universe']."</th><td class=\"c\">".$lang['se_galaxy']."</th><td class=\"c\">".$lang['se_system']."</th><td class=\"c\">".$lang['se_planet']."</th></tr>";
