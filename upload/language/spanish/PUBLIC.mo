...
//index.php
//case lostpassword
$lang['mail_not_exist'] 		= '¡La dirección de correo electrónico no existe!';
...
$lang['server_description']		= '</strong> es un <strong>juego de simulación estratégica espacial</strong> con <strong>miles de jugadores</strong> a lo largo del mundo compitiendo por ser el mejor <strong>simultáneamente</strong>. Todo lo que necesitas para jugar, es un navegador web estándar.';
