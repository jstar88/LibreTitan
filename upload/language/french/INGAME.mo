...
$lang['page_doesnt_exist']					= 'La page demandée n\'existe pas';
...
$lang['gl_i']								= 'i';
$lang['gl_I']								= 'I';
$lang['gl_populed_planets']					= 'planètes colonisées';
$lang['gl_out_space']						= 'Espace infini';
$lang['gl_avaible_missiles']				= 'missiles disponibles';
$lang['gl_fleets']							= 'slots de flottes utilisés';
...
$lang['gl_debris_field']					= 'Champ de débris';
$lang['gl_collect']							= 'Collecter';
$lang['gl_resources']						= 'Ressources';
$lang['gl_features']						= 'Caractéristiques';
...
$lang['phalanx_rangeerror']         = 'pas autorisé!';  
...
$lang['bd_building_shipyard']				= 'Vous ne pouvez pas construire de vaisseaux pour l\évolution du chantier spatial !';
...
$lang['of_max_lvl']							= 'Niveau maximum';
$lang['of_available_points']				= 'Points disponibles:';
$lang['of_points_per_thousand_darkmatter']	= '(1 point pour 1000 anti-matière)';
$lang['of_lvl']								= 'niveau';
...
$lang['tr_darkmatter_needed']				= 'Vous avez besoin d\'au moins <font color="#FF8900">%s anti-matière</font> pour voir le marchand.';
...
216 => "Le SuperNova est le vaisseau le plus puissant jamais créé, avec une grand puissance offensive qu'aucun vaisseau ne sera en mesure de résister à son attaque.",
...
409 => "La protection maximale et ultime pour les planètes.",
502 => "Le missile interception détruit les missiles adverses.",
503 => "Les missiles interplanétaires détruisent la défense adverse.",

601 => 'Le géologue est un expert reconnu en astrominéralogie et en astrocristallographie. Avec son équipe d\'experts en métallurgie et d\'ingénieurs chimiste, il assiste les gouvernements interplanétaires dans la recherche de nouvelles sources de matières premières et optimise le raffinage de celles-ci.<br><br><strong><font color="lime">+5% de production. Niveau Max. : 20</font></strong>',
602 => 'L\'amiral de la flotte est un vétéran de guerre et un stratège redouté. Même lorsque le combat est acharné, il garde le sang froid nécessaire pour dominer la situation et est en contact permanent avec les amiraux sous ses ordres. Un empereur responsable ne saurait se passer de l\'amiral de la flotte pour coordonner ses attaques et peut lui faire une telle confiance qu\'il peut envoyer plus de flottes en combat.<br><br><strong><font color="lime">+5% de bouclier, protection des vaisseaux et armes sur les vaisseaux. Niveau Max. : 20</font></strong>',
603 => 'L\'ingénieur est un spécialiste de la gestion d\'énergie. En temps de paix, il optimise l\'efficacité des réseaux d\'énergie des colonies.<br><br><strong><font color="lime">+5% d\'énergie. Niveau Max. : 10</font></strong>',
604 => 'Les guildes de technocrates sont des scientifiques au génie reconnu. On les trouve aux endroits où la technologie est poussée au delà de ses limites. Personne ne parviendra à déchiffrer le cryptage d\'un technocrate, sa seule présence inspire les chercheurs de tout l\'empire.<br><br><strong><font color="lime">-5% de temps de construction des vaisseaux. Niveau Max. : 10</font></strong>',
605 => 'Le constructeur est un nouveau type de bâtisseur. Son ADN a été modifiée pour lui conférer une force surhumaine. Un seul de ces "hommes" peut construire une ville entière.<br><br><strong><font color="lime">-10% au temps de construction. Niveau Max. : 3</font></strong>',
606 => 'Les scientifiques font partis d\'une guilde concurente à celle des technocrates. Ils sont spécialisés dans l\'amélioration des technologies.<br><br><strong><font color="lime">-10% au temps de recherche. Niveau Max. : 3</font></strong>',
607 => 'Le stockeur fait parti de l\'ancienne confrérie de la planète Hsac. Sa devise est de gagner un maximum mais pour celà il lui faut des espaces de stockage important. C\'est pourquoi à l\'aide du constructeur il a développé une nouvelle technique de stockage.<br><br><strong><font color="lime">+50% de stockage. Niveau Max. :2</font></strong>',
608 => 'Le défenseur est membre de l\'armée impériale. Son ardeur dans son travail lui permet de construire une défense redoutable en peu de temps dans les colonies hostiles.<br><br><strong><font color="lime">-25% de temps de construction de la défense. Niveau Max. : 2</font></strong>',
609 => 'L\'empereur a remarqué le travail impressionnant que vous avez fournit à son empire. Pour vous remerciez, il vous offre la chance de devenir Protecteur. Le protecteur est la plus haute distinction de la branche Minière de l\'armée impériale.<br><br><strong><font color="lime">Débloquage du Protecteur Planétaire. Niveau Max. : 1</font></strong>',
610 => 'L\'espion est une personne énigmatique. Personne n\'a jamais vu son visage réel, a moins d\'être déjà mort.<br><br><strong><font color="lime">+5 niveau d\'espionnage. Niveau Max. : 2</font></strong>',
611 => 'Le commandant de l\'armée impériale est passé maître dans l\'art du maniement des flottes. Son cerveau peut calculer les trajectoires de nombreuses flotte, beaucoup plus que celle d\'un humain normal.<br><br><strong><font color="lime">+3 slots de flottes. Niveau Max. : 3</font></strong>',
612 => 'Le destructeur est un officier sans pitié. Il a massacré des planètes entières juste pour son plaisir. Il développe actuellement une nouvelle méthode de production d\'étoiles de la mort.<br><br><strong><font color="lime">2 RIP construites au lieu d\'une. Niveau Max. : 1</font></strong>',
613 => 'Le général est une vénérable personne qui a servit de nombreuses années dans l\'armée. Les ouvriers constructeurs de vaisseaux produisent plus vite en sa présence.<br><br><strong><font color="lime">-10% au temps de construction des vaisseaux. Niveau Max. : 3</font></strong>',
614 => 'L\'empereur a repéré en vous des qualités indéniables de conquérant. Il vous propose de devenir Conquérant. Le conquérant est le grade le plus élevé de la branche des raideurs de l\'armée impériale.<br><br><strong><font color="lime">Débloquage du SuperNova. Niveau Max. : 1</font></strong>',
615 => 'Vous avez montré que vous étiez le plus grand conquérant de l\'univers. Il est tant pour vous de prendre la place qui vous revient.<br><br><strong><font color="lime">Débloquage du Destructeur Planétaire. Niveau Max. : 1</font></strong>',
);
...
$lang['info'][204]['description'] 			= "Le chasseur léger est un vaisseau très manœuvrable qui est stationné sur presque toutes les planètes. Il ne coûte pas trop cher, mais la puissance de son bouclier et sa capacité de fret sont très limitées.";
...
$lang['info'][216]['description']        	= "Le SuperNova est le vaisseau le plus puissant jamais créé, avec une grand puissance offensive qu'aucun vaisseau ne sera en mesure de résister à son attaque.";
...
$lang['info'][409]['name']        			= "Protecteur Planétaire";
$lang['info'][409]['description'] 			= "La protection maximale et ultime pour les planètes.";
...
$lang['info'][605]['description'] 			= "Le constructeur est un nouveau type de bâtisseur. Son ADN a été modifiée pour lui conférer une force surhumaine. Un seul de ces \"hommes\" peut construire une ville entière.";
$lang['info'][606]['name']        			= "Scientifique";
$lang['info'][606]['description'] 			= "Les scientifiques font partis d'une guilde concurente à celle des technocrates. Ils sont spécialisés dans l'amélioration des technologies.";
$lang['info'][607]['name']        			= "Stockeur";
$lang['info'][607]['description'] 			= "Le stockeur fait parti de l'ancienne confrérie de la planète Hsac. Sa devise est de gagner un maximum mais pour celà il lui faut des espaces de stockage important. C'est pourquoi à l'aide du constructeur il a développé une nouvelle technique de stockage.";
$lang['info'][608]['name']        			= "Défenseur";
$lang['info'][608]['description'] 			= "Le défenseur est membre de l'armée impériale. Son ardeur dans son travail lui permet de construire une défense redoutable en peu de temps dans les colonies hostiles.";
$lang['info'][609]['name']        			= "Protecteur";
$lang['info'][609]['description'] 			= "L'empereur a remarqué le travail impressionnant que vous avez fournit à son empire. Pour vous remerciez, il vous offre la chance de devenir Protecteur. Le protecteur est la plus haute distinction de la branche Minière de l'armée impériale.";
$lang['info'][610]['name']        			= "Espion";
$lang['info'][610]['description'] 			= "L'espion est une personne énigmatique. Personne n'a jamais vu son visage réel, a moins d'être déjà mort.";
$lang['info'][611]['name']        			= "Commandant";
$lang['info'][611]['description'] 			= "Le commandant de l'armée impériale est passé maître dans l'art du maniement des flottes. Son cerveau peut calculer les trajectoires de nombreuses flotte, beaucoup plus que celle d'un humain normal.";
$lang['info'][612]['name']        			= "Destructeur";
$lang['info'][612]['description'] 			= "Le destructeur est un officier sans pitié. Il a massacré des planètes entières juste pour son plaisir. Il développe actuellement une nouvelle méthode de production d'étoiles de la mort.";
$lang['info'][613]['name']        			= "Général";
$lang['info'][613]['description'] 			= "Le général est une vénérable personne qui a servit de nombreuses années dans l'armée. Les ouvriers constructeurs de vaisseaux produisent plus vite en sa présence.";
$lang['info'][614]['name']        			= "Conquérant";
$lang['info'][614]['description'] 			= "L'empereur a repéré en vous des qualités indéniables de conquérant. Il vous propose de devenir Conquérant. Le conquérant est le grade le plus élevé de la branche des raideurs de l'armée impériale.";
$lang['info'][615]['name']        			= "Empereur";
$lang['info'][615]['description'] 			= "L'empereur place à disposition sous son commandement tous les officiers de l'empire, en combinant leurs compétences à dominer l'univers et de devenir un adversaire presque invinsible.";
...
$lang['ccs_multiple_users']					= 'Erreur de cookies ! Plusieurs utilisateurs utilisent ce nom ! Vous devez supprimer vos cookies. En cas de problèmes, veuillez contacter l\'admininistrateur.';
$lang['ccs_other_user']						= 'Erreur de cookies ! Votre cookie ne correspond pas au compte ! Vous devez supprimer vos cookies. En cas de problèmes, veuillez contacter l\'admininistrateur.';
$lang['css_different_password']				= 'Erreur de cookies ! Erreur de session, vous devez vous reconnecter ! Vous devez supprimer vos cookies. En cas de problèmes, veuillez contacter l\'admininistrateur.';
