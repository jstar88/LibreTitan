...
$lang['server_register']		= 'S\'enregister !';
...
$lang['welcome_message_content']	= 'Bienvenue sur XG project !<p>Au début, construiser une mine de métal.<br />Pour la faire, cliquer sur le lien "Bâtiments" dans le menu à gauche, et cliquer sur "Construire" à droite de la mine de métal.<br />Maintenant vous avez du temps pour en apprendre davantage sur le jeu.<p>Pour plus d\'aide:<br />Aller dans notre <a href=\"http://www.xtreme-gamez.com.ar/foros\" target=\"_blank\">Forum</a><br />Maintenant, votre mine devrait être terminée.<br />Comme vous ne pouvez rien produire sans énergie, vous devez construire une centrale électrique solaire, retourner dans "Bâtiments", et choisisser de construire une centrale électrique solaire.<p>Pour voir tous les vaisseaux, défenses, bâtiments et recherches débloquables, vous pouvez jeter un oeil à l\'arbre technologique dans "Technologie" dans le menu de gauche.<p>Vous pouvez maintenant commencer la conquête de l\'univers... Bonne chance !';
