...
<form action="game.php?page=fleet2" method="post" onsubmit='this.submit.disabled = true;'>
    ...
    <input type="hidden" name="thisuniverse"     value="{universe}" />
    ...
    <input type="hidden" name="universeend"      value="{universe_post}" />
    ...
    <div id="content">
    	<table width="519" border="0" cellpadding="0" cellspacing="1">
            ...
            <tr height="20">
            	...
            	<th>
            	      <input name="universe" size="3" maxlength="2" onChange="shortInfo()" onKeyUp="shortInfo()" value="{u}" />
