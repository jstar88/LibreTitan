<form action="MissilesAjax.php?c={current}&mode=2&universe={universe}&galaxy={galaxy}&system={system}&planet={planet}" method="POST">
	<tr>
		<table border="0">
			<tr>
				<td class="c" colspan="2">{gl_missil_launch} [{universe}:{galaxy}:{system}:{planet}]</td>
			</tr>
			<tr>
