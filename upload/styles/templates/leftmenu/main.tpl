   ...
   <center>
      <div id='menu'>
         ...
         <table width="110" cellspacing="0" cellpadding="0">
            <tr>
               <td>
                  <img src="{dpath}gfx/ogame-produktion.jpg" width="110" height="40" />
               </td>
            </tr>
                  ...
                  <div align="center" >
                     <font color="#FFFFFF">
                        <a href='game.php?page=trader'>
                           <font color='FF8900'>{lm_trader}</font>
                        </a> 
                     </font>
                  </div>
               </td>
 	         ...
 	         <tr>
	           <td>
                  ...
                  <font color="#FFFFFF">
                        ...
                        <font color='FF8900'>{lm_officiers}</font>
                     </a>
	               </font>
               </div>
	           </td>
            ...
            <tr>
               <td>  
                  <img src="{dpath}/gfx/user-menu.jpg" width="110" height="35">
               </td>
            </tr>
            ...
            <tr>
               <td>
                  <div align="center">
                     <font color="#FFFFFF">
                        <a href="#" title="Powered by LibreTitan {version} &copy; 2011 GNU General Public License">&copy;2011</a>
                     </font>
                  </div>
               </td>
            </tr>
